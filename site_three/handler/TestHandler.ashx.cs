...
namespace xinxi
{
    ...
    public class TestHandler : IHttpHandler
    {
        ...
        public string MainPage(HttpContext context)
        {
            ...
            return SqlHelper.WriteTemplate(data, "MainPage.html");
        }
        #endregion
        ...
        public string GetProduct(HttpContext context)
        {
            ...
            return SqlHelper.WriteTemplate(data, "Product.html");
        }
        #endregion
        ...
        public string DetailPage(HttpContext context)
        {
            ...
            try
            {
                ...
                string html = SqlHelper.WriteTemplate(data, "DetailModel.html");
                return html;
            }
            catch (Exception ex)
            {
        ...
        public string SiteMapXML(HttpContext context)
        {
            ...
            string html = SqlHelper.WriteTemplate(data, "sitemap.xml");
            return html;
        }
        #endregion
        ...
        public string SiteMapHtml(HttpContext context)
        {
            ...
            return SqlHelper.WriteTemplate(data, "sitemap.html");
        }
        #endregion
